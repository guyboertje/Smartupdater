...
(function(jQuery) {
	jQuery.fn.smartupdater = function (options, callback, errorback) {
		...
		return this.each(function () {
			...
			es.errorback    = errorback;
			es.origReq = {url:es.url,data:es.data,callback:callback, errorback: errorback};
			es.stopFlag = false;
	...
	jQuery.fn.smartupdaterAlterErrorback = function (errorback) {
		return this.each(function () {
			this.settings.errorback  = errorback	? errorback 	: this.settings.origReq.errorback;
 		});
	};
